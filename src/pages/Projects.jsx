  ...
  const myProjects = [
    {
      ...
      description:
        "A HAND'S ON full-stack e-commerce application with user authentication, shopping cart, and payment integration. Built with React, Node.js, and MongoDB.",
    ...
    },
    {
      ...
      title: 'OpenATS+',
      description:
        'An AI-ready Applicant Tracking System that helps developers optimize resumes for job applications. It allows users to upload resumes, track applications, and analyze resume compatibility with job descriptions through a clean and modern dashboard.',
      technologies: [
        'React',
        'Node.js',
        'Express.js',
      ...
      image: '📄',
      github: 'https://github.com/manikanta240/ATS.gitS',
